...
1. Generate plots from the existing output of 🧛‍♀️ and FPerf without running either 🧛‍♀️ or FPerf
2. Use the existing output of FPerf and generate the output of 🧛‍♀️
