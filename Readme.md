...
- Charts to compare the average verification time of workloads in 🧛‍♀️ and FPerf

To reproduce the result claimed in the paper, we proceed in 4 steps:

1. Generate charts from the existing output of 🧛‍♀️ and FPerf without running either 🧛‍♀️ or FPerf
